...
//! data table speak. The api (native) crate produces these from the `data`
//! engine. Ported from redpash-rust-pwa `crates/shared/src/file.rs`.
...
/// See docs/numu-csv-flow-and-datatypes.md.
