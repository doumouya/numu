//! numu-api — the HTTP edge. Bootstraps the pool, runs migrations, loads the type registry, and serves the
//! generic object surface behind the request-id + trace middleware. (docs/HTTP.md, docs/OBSERVABILITY.md)
