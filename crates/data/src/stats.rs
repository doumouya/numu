//! Purpose: the file-level CLEANNESS SCORE (0-100) — the instant quality
//! report. Ported verbatim from redpash-rust-pwa (the calibration is the moat):
//!
...
//!     fifth averaged component.
//! Sentinels route through the unified `crate::sentinels`. See
//! docs/numu-csv-flow-and-datatypes.md §5.
...
/// each canonicalised. The owned vec must outlive the borrowed set.
