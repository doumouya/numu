...
//! 2-letter language hint to disambiguate single-byte codecs. Ported from
//! redpash-rust-pwa (the `tld` hint is actually passed to chardetng here).
...
/// Decode with a caller-chosen codec, skipping detection (the user override).
...
mod tests {
    ...
    #[test]
    fn tld_hint_is_accepted_and_bad_hints_ignored() {
